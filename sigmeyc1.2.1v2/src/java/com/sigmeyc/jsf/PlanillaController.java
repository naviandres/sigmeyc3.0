...
public class PlanillaController implements Serializable {
    ...
    public String guardar() {
        ...
        init();
        return "/app/crud/planilla/Create.xhtml?faces-redirect=true";
    }
    ...
    public String prepareView(Planilla p) {
        this.planilla = p;
        return "/app/crud/planilla/View.xhtml?faces-redirect=true";
    }

    public String prepareList() {
        return "/app/crud/planilla/List.xhtml?faces-redirect=true";
    }
    ...
    public String Editar(Planilla p) {
        setPlanilla(p);
        return "/app/crud/planilla/Edit.xhtml?faces-redirect=true";
    }
