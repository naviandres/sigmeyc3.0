...
public class NovedadController implements Serializable {
    ...
    private Novedad current;
    private DataModel items = null;
    @EJB
    private com.sigmeyc.beans.NovedadFacade ejbFacade;
    ...
    private NovedadFacade getFacade() {
        return ejbFacade;
    }
    ...
    public String prepareView() {
        current = (Novedad) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("NovedadCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("NovedadUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("NovedadDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
...
//                return getStringKey(o.getCodigoNovedad());
//            } else {
